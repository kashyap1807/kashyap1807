...
- 👨🏻‍💻 Full-stack developer with 1.5+ year of experience building scalable web applications using ASP.NET Core, Angular, Azure, CI/CD pipelines & SQL. Strong focus on performance optimization, secure authentication, and cloud-native deployment. Proven ability to deliver robust features with high code quality and testing standards.
